...
namespace system\lib\guzzle\psr7;
if (!interface_exists( 'Psr\Http\Message\UriInterface')){
	include_once __DIR__.'/../../../../vendor/psr/http-message/src/UriInterface.php';
}
if (!interface_exists( 'Psr\Http\Message\MessageInterface')){
	include_once __DIR__.'/../../../../vendor/psr/http-message/src/MessageInterface.php';
}
if (!interface_exists( 'Psr\Http\Message\ResponseInterface')){
	include_once __DIR__.'/../../../../vendor/psr/http-message/src/ResponseInterface.php';
}

if (!interface_exists( 'Psr\Http\Message\StreamInterface')){
	include_once __DIR__.'/../../../../vendor/psr/http-message/src/StreamInterface.php';
}

if (!interface_exists( 'Psr\Http\Message\RequestInterface')){
	include_once __DIR__.'/../../../../vendor/psr/http-message/src/RequestInterface.php';
}


use Psr\Http\Message\UriInterface;use function interface_exists;
